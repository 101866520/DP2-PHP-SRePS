...
namespace PHP_SRePS
{
    ...
    class Stock
    {
        ...
        {
            string alterString = @"update stock set stock_quantity= stock_quantity - '" + item.ItemQuantity + "' where product_Name = '" + item.ItemName + "'";
            return alterString;
        }
        ...
        {
            string insertString = @"insert into stock(product_no, stock_quantity,product_Name ) values ('" + item.ItemNo + "','" + item.ItemQuantity + "','" + item.ItemName + "')";
            return insertString;
        }
        /// <summary>
        ...
        {
            string alterString = @"update stock set stock_quantity= stock_quantity + '" + item.ItemQuantity + "' where product_no = '" + item.ItemNo + "'";
            return alterString;
        }
        public string CheckingItemQuantity()
        {
            string returnString = "DELETE FROM stock WHERE stock_quantity <=0";
            return returnString;
        }
    }
